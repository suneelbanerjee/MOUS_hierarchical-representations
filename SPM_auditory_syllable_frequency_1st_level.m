...
outdir = '/home/neel/Documents/SPM_results/SPM-A_syllables_phon_freqRegresors_mthresh';
mkdir(outdir)
...
for m = 62:length(subjNames)
    try
        ...
        regressors = readtable(char(fullfile(sourcedir,currentName,'func',strcat(currentName,'_phon_freqRegresors.xlsx'))));
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).param = 0 - regressors.logMinimum
        matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).poly = 1;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.mthresh = 0.8; %default is 0.8
        ...
        insig_subs = [insig_subs;insig_subs];
    end
end
