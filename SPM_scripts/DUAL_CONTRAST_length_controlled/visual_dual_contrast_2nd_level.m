...
firstlevel_dir = fullfile('/mnt/MOUSnew/SPM_results/DUAL_CONTRAST_length_controlled/visual_word_len1_plus1minBG1_WF1')
output = '/mnt/MOUSnew/SPM_results/DUAL_CONTRAST_length_controlled/second_level'
%
...
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'Visual Word Frequency Correlation (with bigram frequency included as a covariate of no interest)';
