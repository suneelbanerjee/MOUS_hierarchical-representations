...
outdir = '/home/neel/Documents/SPM_results/alternate_parameter_contrasts/SPM-A_syllables_guslatho_max';
mkdir(outdir)
...
for m = 1:length(subjNames)
    ...
    regressors.Max_Freq_Count = regressors.Max_Log10_FreqCount;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).param = 0 - (regressors.Max_Freq_Count - mean(regressors.Max_Freq_Count))
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).poly = 1;
    ...
    matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'Max Syllable Frequency';
