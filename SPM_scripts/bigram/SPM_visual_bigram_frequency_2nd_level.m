...
output = '/media/lillianchang/MOUSnew/SPM_results/FIRST/first_bigram_2nd_level'
%'/media/neel/MOUS/MOUS/MOUS/SPM_results/mean_centered_nolength/second_level/visual_WF0_minBG1';
firstlevel_dir = fullfile('/media/lillianchang/MOUSnew/SPM_results/FIRST/first_bigram')
...
%'Min Bigram Frequency Correlation (log10(freqcount + 1), length_control)';
