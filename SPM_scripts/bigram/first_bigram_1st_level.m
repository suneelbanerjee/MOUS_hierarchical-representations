...
subject_path = '/media/lillianchang/MOUSnew/fmriprep_fresh'; 
%replace with directory containing source data.
source = '/media/lillianchang/MOUSnew/SynologyDrive/source/SynologyDrive'
%replace with directory for output.  
outdir = '/media/lillianchang/MOUSnew/SPM_results/FIRST/first_bigram'
...
for v=1:length(subjNames)
    ...
    regressors = readtable(char(fullfile(source, currentName, 'func', strcat(currentName,'_first_bigram_zipf.csv'))),'Delimiter',',');
