...
for v=1:length(subjNames)
    ...
    %Regressor 3: bigram frequency
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(2).name = 'Min Bigram Frequency';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(2).param = 0-(regressors.log10_Min_plus1_Bigram - mean(regressors.log10_Min_plus1_Bigram))
