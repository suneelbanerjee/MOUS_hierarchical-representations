...
outdir = '/home/neel/Documents/SPM_results/alternate_parameter_contrasts/SPM-A_syllables_IPA_eSpeak_mean_ijfix2';
mkdir(outdir)
...
for m = 1:length(subjNames)
    ...
    regressors.Mean_Freq_Count = log10(regressors.Mean_Freq_Count);
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).param = 0 - regressors.Mean_Freq_Count
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).poly = 1;
