...
output = '/media/neel/MOUS/MOUS/MOUS/SPM_results/mean_centered_nolength/second_level/visual_WF0_minBG1';
firstlevel_dir = fullfile('/media/neel/MOUS/MOUS/MOUS/SPM_results/mean_centered_nolength/visual_WF0_minBG1');
...
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'Min Bigram Frequency Correlation (Regressing out words)';
