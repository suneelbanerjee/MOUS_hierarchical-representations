...
outdir = '/home/neel/Documents/SPM_results/SPM-A_syllables_IPA_guslatho_syllableZipf';
mkdir(outdir)
...
for m = 88:length(subjNames)
    ...
    regressors.Min_Freq_Count = regressors.MinSyllZipf;
    %disp(regressors)
    ...
    % matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(1).param = regressors.Duration - mean(regressors.Duration) %demean
