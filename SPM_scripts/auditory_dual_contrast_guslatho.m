...
outdir = '/media/neel/MOUS/MOUS/MOUS/SPM_results/mean_centered/auditory_guslatho_dur0_syll0_WF1';
mkdir(outdir)
...
%     end
   ...
   %%%%%%%%%%REGRESSOR DEFINITION
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(3).name = 'Word Frequency';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(3).param = 0 - (word_regressors_edited.Zipf - mean(word_regressors_edited.Zipf)); %Lg10WF and Zipf represent two alternate logarithmic measures of word frequency. 
