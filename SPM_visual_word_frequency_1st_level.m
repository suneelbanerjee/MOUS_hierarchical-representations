...
outdir = '/home/neel/Documents/SPM_results/SPM-V_Lg10WF'
...
for v=1:length(subjNames)
    ...
    regressors = readtable(char(fullfile(source, currentName, 'func',strcat(currentName,'_word_frequencies.csv'))))
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(1).param = regressors.Lg10WF - mean(regressors.Lg10WF);
