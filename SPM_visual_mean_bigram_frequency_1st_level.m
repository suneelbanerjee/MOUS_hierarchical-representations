...
outdir = '/home/neel/Documents/SPM_results/alternate_parameter_contrasts/SPM-V_Lg10_mean_bigram'
if ~exist(outdir,'dir')
    mkdir(outdir)
end
cd(subject_path) 
...
for v=1:length(subjNames)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(1).param = 0 - regressors.log10_Mean_Bigram %- mean(regressors.log10_Min_Bigram);
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(1).poly = 1;
