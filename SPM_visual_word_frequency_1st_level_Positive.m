...
outdir = '/home/neel/Documents/SPM_results/SPM-V_Zipf_multireg_positive'
...
for v=44:length(subjNames)
    ...
    if exist(fullfile(subject_path,currentName,'func'))
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod(2).param = regressors.Zipf %- mean(regressors.Lg10WF);
        ...
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = char(strcat("Word Frequency (Pos) Correlation"));
