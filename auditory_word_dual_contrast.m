...
outdir = '/home/neel/Documents/SPM_results/reviewer_suggestions/auditory_dur0_syll0_WF1';
mkdir(outdir)
...
%regressor 0, onset
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(2).param = 0 - regressors.Min_Freq_Count;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(3).param = 0 - word_regressors_edited.Zipf; %Lg10WF and Zipf represent two alternate logarithmic measures of word frequency. 
