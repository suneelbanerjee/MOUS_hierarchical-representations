...
outdir = '/home/neel/Documents/SPM_results/SPM-A_syllables_processed_no_mthresh_NO_multireg_duration_control';
mkdir(outdir)
...
for m = 1:length(subjNames)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod(2).param = regressors.Minimum_Syllable_Frequency
